...
function normalizeStrategyVersion(input: unknown): RuntimeStrategyVersionOption {
  ...
  const label = versionNumber !== null ? `v${versionNumber}` : readString(source, ["label", "name"], "N/A");
  ...
  return {
    ...
    versionNumber,
    label,
    parameterTemplate: readObjectMap(source, ["parameter_template", "parameterTemplate", "parameters_snapshot", "parametersSnapshot"]),
