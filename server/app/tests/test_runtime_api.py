            ...
            session.add_all(
                [
                    ...
                    StrategyVersionModel(
                        ...
                        version_number=1,
                        code_snapshot="print('runtime')",
                        parameters_snapshot={"window": 12, "risk_mode": "standard"},
                        version_note="Runtime baseline",
